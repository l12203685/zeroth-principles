## Linear Algebra, 3ed, 2004 — Serge Lang
**來源**: E:/書籍/Linear Algebra, 3ed, 2004, by Serge Lang.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
- **CHAPTER V Scalar Products and Orthogonal ity**
...
### TL;DR (≤120字)
本書屬於 general trading 範疇,作者 Serge Lang 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
