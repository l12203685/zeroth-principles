## ngt2011sh5 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW/解答/ngt2011sh5.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Two workers can each choose to or not to make an eﬀort for th**
- **2.
Thus this game has a symmetric pure-strategy BE in which, for**
- **3.
Note that to fulﬁll productive eﬃciency we should have exactl**
- **2.
2. Let us modify the game of chain-store paradox in Lecture 4**
- **2.
There are two remaining cases.**
- **4. In this pooling equilibrium preying E1 thus yields for the sa**
- **4. This fact can be proved by contraposition**
