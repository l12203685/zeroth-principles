## PS.Chapter.1 — 未標示
**來源**: E:/課程/[3] 數理統計/NOTE/PS.Chapter.1.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **2. If C 2 B then Cc 2 B:**
- **3. If the sequence of sets fC1; C2; : : :g is in B then [1**
- **1. P (C)  0**
- **2. P (C) = 1**
- **3. If Cm \ Cn =  for all m 6= n then:**
- **1. P (C2jC1)  0**
- **2. P (C2 [ C3 [    jC1) = P (C2jC1) + P (C3jC1) +    , if**
- **3. P (C1jC1) = 1**
