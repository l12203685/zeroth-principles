## nft2013kyleglostenmilgrom — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/2. 財務相關知識/財務理論/nft2013kyleglostenmilgrom.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Consider the order-driven model in Kyle (1985, Econometrica),**
- **2. Note that in the Bertrand equilibrium of the subgame where ma**
