## 0009American option_v2_expanded — 未標示
**來源**: E:/投資交易/量化金融文獻/知識素材/0009American option_v2_expanded.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Exercise the option to receive **
- **2. Keep it until time N (next step) European derivative secur**
