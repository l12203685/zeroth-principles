## ngt2012sh3 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW (1)/解答/ngt2012sh3.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (Entry Deterrence by a Monopolistic Incumbent.)**
- **5. Find the equilibrium qA1 and qA2.**
- **25. Find the equilibrium qA1 and qA2.**
- **9.
Next, consider the date-1 subgame where qA1 has been chosen,**
- **9.
Note that we have assumed that ﬁrm B will stay out if enterin**
- **4.
• If qA1 is such that**
- **2. Thus it is indeed optimal for**
- **9. On the other hand, ﬁrm A’s optimal date-**
- **9. Thus we conclude that choosing q∗**
