## QA_2012_Ch.1,2,3 — 未標示
**來源**: E:/課程/經濟_計量經濟學/Lecture/QA_2012_Ch.1,2,3.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Compare average test scores in districts with low STRs to**
- **2. Test the ”null” hypothesis that the mean test scores in the**
- **3. Estimate an interval for the diﬀerence in the mean test score**
