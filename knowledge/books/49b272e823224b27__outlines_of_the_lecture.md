## Outlines of the Lecture — 未標示
**來源**: E:/課程/數學統計_數理統計/Outlines of the Lecture.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Syllabus**
- **2. What is R?**
- **Chapter 1.1, 1.2, 1.3, and 1.4, Hogg, McKean and Craig (2005), Introduction to**
- **Chapter 1.1, 1.2, and 1.3, Verzani, John (2005), Using R for Introductory Statistics,**
- **Chapter 1.5, 1.6, and 1.7, Hogg, McKean and Craig (2005), Introduction to**
- **Chapter 2.1, and 2.2, Verzani, John (2005), Using R for Introductory Statistics,**
- **Chapter 1.8, 1.9, and 1.10, Hogg, McKean and Craig (2005), Introduction to**
- **Chapter 2.1, 2.2, and 2.3, Verzani, John (2005), Using R for Introductory Statistics,**
