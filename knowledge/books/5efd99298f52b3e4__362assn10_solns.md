## 362assn10-solns — 未標示
**來源**: E:/課程/數學統計_數理統計/數統二練習題/362assn10-solns.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (7.5.10) Let X1, . . . , Xn be a random sample from a distrib**
- **2. (8.1.2) Let the random variable X have the pdf f(x; θ) = (1/θ**
- **3. (8.2.8) Let X1, . . . , Xn denote a random sample from a norm**
- **4. (8.2.11) Let X1, . . . , Xn be a random sample from a distrib**
