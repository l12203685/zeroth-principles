## inv2008lecture2 — 未標示
**來源**: E:/課程/財務金融_投資學/陳其美_投資學/inv2008lecture2.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. There are three dimensions of an investor that matter in asse**
- **2. The ﬁrst part of this note deﬁnes rational investor, and pose**
- **1. A decision maker facing a set A of feasible alternatives is s**
- **2. Consider a date-0 investment environment where all investment**
- **3. Our ﬁrst remain result is that, a rational investor’s weak pr**
