## [3] Introduction to Econometrics, 2ed — Stock J. H. and H. W. Watson [中譯本]
**來源**: E:/課程/[3] 計量經濟學/[3] Introduction to Econometrics, 2ed, by Stock J. H. and H. W. Watson [中譯本].pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
### TL;DR (≤120字)
本書屬於 general trading 範疇,作者 Stock J. H. and H. W. Watson [中譯本] 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
