## FM-09-05ques — 未標示
**來源**: E:/課程/證照考試資料/SOA/2. FM/FM-09-05ques.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. 
Bruce deposits 100 into a bank account.  His account is credi**
- **2. 
  
Kathryn deposits 100 into an account at the beginning of each**
- **3. 
  
Eric deposits 100 into a savings account at time 0, which pay**
- **4. 
  
John borrows 10,000 for 10 years at an annual effective inter**
- **5. 
  
An association had a fund balance of 75 on January 1 and 60 o**
- **6.        
A perpetuity costs 77.1 and makes annual payments at the end**
- **7. 
  
1000 is deposited into Fund X, which earns an annual effectiv**
- **8. 
...
A 10,000 par value 10-year bond with 8% annual coupons is bou**
