## Homework-12 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_賽局理論/homework/Homework-12.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1.
[von Stackelberg duopoly model] Imagine a market in which two**
- **2. Imagine a market setting with three ﬁrms. Firms 2 and 3 are a**
- **3. Consider the following market game: An incumbent ﬁrm, called**
