## Exam_M_2000_2 — 未標示
**來源**: E:/投資交易/研究與模型/SOA/SOA Past Exam_Preliminery/Exam_M_2000_2.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1.
For independent lives (x) and (y):**
- **2.
In a clinic, physicians volunteer their time on a daily basis**
- **3.
A person age 40 wins 10,000 in the actuarial lottery.  Rather**
- **4.
Mortality for Audra, age 25, follows De Moivre’s law with ω =**
- **5.
For a 5-year fully continuous term insurance on (x):**
- **6.
An insurance company has two insurance portfolios.  Claims in**
- **7.
For a multiple decrement table, you are given:**
- **8.
The number of claims, N, made on an insurance portfolio follo**
- **9.
For a special whole life insurance of 100,000 on (x), you are**
- **10. You are given the following extract from a select-and-ultimat**
