## ngt2009h1-solution — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW/解答/ngt2009h1-solution.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1.     首先我們查看賽局中有沒有單純策略的均衡，先從consumer H 的角度出發，我們可以**
- **2.  
( i ) 若firm 1 選擇產量q1 則firm2 面臨的利潤極大化問題如下:**
- **3.  
( i )**
