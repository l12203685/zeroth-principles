## matlab_exercise — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/財工/MATLAB/matlab_exercise.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (a)  寫出一函數，用三元樹計算歐式買權，名稱為TriEuCall(s0,k,r,si,t,n)**
- **2. 用三元樹計算美式賣權價格，並記錄它出在每個時間點的Early exercise**
- **3. 現有一新奇的歐式買權，其定義如下：**
