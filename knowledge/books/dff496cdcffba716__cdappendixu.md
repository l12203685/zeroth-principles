## CDAppendixU — 未標示
**來源**: E:/課程/數學統計_統計學/keller8e/manual_install/CDAppendixes/CDAppendixU.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Type or import the data into adjacent columns. (Open XmU-01.)**
