## [Robb_J._Muirhead]_Aspects_of_multivariate_statist(BookFi.org) — 未標示
**來源**: E:/書籍/[Robb_J._Muirhead]_Aspects_of_multivariate_statist(BookFi.org).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 1: The Multivariate Normal and Related Distributions 1 . I .**
