## ngt2011sh4 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW (1)/解答/ngt2011sh4.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. We shall consider in this exercise two applications of Friedm**
- **3.
Each player gets the payoﬀ24**
- **2.
This ﬁnishes part (i) and part (ii).**
- **4.
This ﬁnishes part (i) and part (ii).**
