## smm2013lecture4 — 未標示
**來源**: E:/課程/財務金融_證券市場微結構理論/lecture/smm2013lecture4.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Most earlier models are inventory-based models. We shall revi**
- **2. Demsetz (1968) seems to be the ﬁrst work emphasizing order im**
- **3. Unlike Demsetz (1968) where the focus is on the trading desir**
- **4. Amihud and Mendelson (1980) extend Garman’s study to allow pr**
- **5. Stoll (1978) takes a diﬀerent view about the bid-ask spread:**
