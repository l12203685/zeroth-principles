## MIT Press - Game Theory--Fudenberg & Tirole--579p — 未標示
**來源**: E:/書籍/MIT Press - Game Theory--Fudenberg & Tirole--579p.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **MIT Press - Game Theory--Fudenberg & Tirole--579p**
  - 主題範疇: game theory poker
  - 目錄未能自動提取,以主題領域概括
