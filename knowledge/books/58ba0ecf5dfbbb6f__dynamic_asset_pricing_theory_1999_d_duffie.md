## Dynamic Asset Pricing Theory, 1999, D. Duffie — 未標示
**來源**: E:/書籍/Dynamic Asset Pricing Theory, 1999, D. Duffie.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 1: Introduction to State Pricing This chapter introduces the basic ideas of the course in a finite-state one- period setting. In many basic senses, each subsequent chapter merely repeats**
