## smm2011lecture2 — 未標示
**來源**: E:/課程/[6] 證券市場微結構/lecture/smm2011lecture2.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Before studying the various trading mechanisms in the real wo**
- **2. We shall carry out our task in two steps. First, in part I of**
- **3. (Part I.)**
- **4. The reason that e is termed payoﬀ-relevant is that only e may**
- **5. Having deﬁned the equilibrium concept REE for the above two-p**
