## 指數選擇權之實證避險表現 SPX 與TXO — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/2. 財務相關知識/papers/指數選擇權之實證避險表現 SPX 與TXO.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **指數選擇權之實證避險表現 SPX 與TXO**
