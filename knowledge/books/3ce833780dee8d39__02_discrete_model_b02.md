## 02_Discrete Model_B02 — 未標示
**來源**: E:/課程/財務工程_隨機財務理論/新增資料夾/02_Discrete Model_B02.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 2: The Binomial Model 2.1 The one period model 2.1.1 Model Description**
