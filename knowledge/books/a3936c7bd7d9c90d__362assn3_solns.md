## 362assn3-solns — 未標示
**來源**: E:/課程/[3] 數理統計/數統二練習題/362assn3-solns.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (5.4.18) Using the assumptions behind the conﬁdence interval**
- **2. (5.4.24) Let ¯X and ¯Y be the means of two independent random**
- **3. (5.5.1) Show that the approximate power function given in exp**
- **4. (5.5.5) Let X1, X2 be a random sample of size n = 2 from the**
- **2.
More rearranging, and we get that this is equivalent to:**
- **5. (5.5.9) Let X have a Poisson distribution with mean θ.**
- **2. Thus Ω= {Θ : 0 < θ ≤1**
- **6. (5.5.11) Let Y1 < Y2 < Y3 < Y4 be the order statistics of a r**
