## smm2013h1 — 未標示
**來源**: E:/課程/[6] 證券市場微結構/homeworks/smm2013h1.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Suppose that people can trade assets in perfect ﬁnancial mark**
- **2. Now, re-consider Problem 1, but assume that p = 2. Show that**
- **3. Recall the complete-markets economy and the martingale pricin**
- **4. There are N people in a two-period production economy with fu**
- **5. Consider an economy with two goods and two competitive consum**
