## 000010Towards continuous time — Brownian Poisson processes
**來源**: E:/投資交易/交易學習資料庫/@交易/2. 財務相關知識/財務數學/000010Towards continuous time-Brownian Poisson processes.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **000010Towards continuous time**
  - 主題範疇: options volatility
  - 目錄未能自動提取,以主題領域概括

### TL;DR (≤120字)
本書屬於 options volatility 範疇,作者 Brownian Poisson processes 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
