## 06-2_Currency Derivatives — 未標示
**來源**: E:/課程/財務工程_隨機財務理論/新增資料夾/06-2_Currency Derivatives.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Investing foreign currency in the foreign**
- **2. Bf units of the foreign currency is worth**
- **3. Trading in the foreign currency is equiva-**
