## Option — Implied Correlations and the Price of Correlation Risk (2005)
**來源**: E:/課程/財務工程_金融創新設計與商品定價/Paper/Option-Implied Correlations and the Price of Correlation Risk/Option-Implied Correlations and the Price of Correlation Risk (2005).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
### TL;DR (≤120字)
本書屬於 options volatility 範疇,作者 Implied Correlations and the Price of Correlation Risk (2005) 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
