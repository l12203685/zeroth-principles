## Roger A. Horn, Charles R. Johnson Matrix Analysis 2nd ed (1) — 未標示
**來源**: E:/書籍/Roger A. Horn, Charles R. Johnson Matrix Analysis 2nd ed (1).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
- **6. Location and Perturbation of Eigenvalues**
  - 6.0 Introduction
  - 6.1 Gerˇsgorin discs
  - 6.2 Gerˇsgorin discs - a closer look
  - ... (2 more sections)
