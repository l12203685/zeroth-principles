## ngt2008h5 — 未標示
**來源**: E:/課程/經濟_商業賽局模型/HW/ngt2008h5.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Consider a two-period model where at date 1, ﬁrm W is all equ**
- **2. At date 0, Mr. A is endowed with an investment project that n**
