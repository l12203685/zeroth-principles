## 2000 Li-On Default Correlation — A Copula Function Approach
**來源**: E:/投資交易/量化金融文獻/知識素材/2000 Li-On Default Correlation- A Copula Function Approach.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **2000 Li-On Default Correlation**
  - 主題範疇: risk management
  - 目錄未能自動提取,以主題領域概括

### TL;DR (≤120字)
本書屬於 risk management 範疇,作者 A Copula Function Approach 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
