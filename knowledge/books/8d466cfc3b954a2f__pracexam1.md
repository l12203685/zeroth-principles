## pracexam1 — 未標示
**來源**: E:/課程/[3] 數理統計/數統一練習題/pracexam1.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (20 points) There are two urns. The ﬁrst has 3 red balls and**
- **2. (20 points) A hand of 4 cards is picked from a standard deck.**
- **3. (20 points) X is a continuous random variable with pdf f(x) =**
- **4. (20 points) Two fair dice are rolled.**
- **5.
(20 points)**
