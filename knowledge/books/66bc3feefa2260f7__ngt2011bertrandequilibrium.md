## ngt2011bertrandequilibrium — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/ngt2011bertrandequilibrium.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Consider the following extensive game. Firms 1 and 2 must com**
- **2. Let Fj(·) be the distribution function for pj in a mixed-stra**
- **2.
Suppose instead that such an equilibrium exists, with ﬁrm 2 p**
