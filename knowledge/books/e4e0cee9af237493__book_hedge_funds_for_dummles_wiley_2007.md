## Book — Hedge funds for dummles (WILEY 2007)
**來源**: E:/書籍/Book - Hedge funds for dummles (WILEY 2007).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
### TL;DR (≤120字)
本書屬於 general trading 範疇,作者 Hedge funds for dummles (WILEY 2007) 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
