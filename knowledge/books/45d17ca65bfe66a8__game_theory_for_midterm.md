## Game Theory_for midterm — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/note (1)/Game Theory_for midterm.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. θ1 = θ.**
- **2. θ2 = γθL + (1 −γ) θH = θ + (1 −γ) δ.**
- **3. θ3 = γθH + (1 −γ) θL = θ + γδ.**
- **4. θ4 = θ + δ.**
- **5. θ = θ1 ≤θ2 ≤θ3 ≤θ4.**
- **6. θ2 −θ1 = (1 −γ) δ.**
- **7. θ3 −θ2 = (2γ −1) δ.**
