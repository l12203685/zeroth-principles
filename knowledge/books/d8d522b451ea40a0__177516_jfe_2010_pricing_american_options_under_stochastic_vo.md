## 177516_JFE.2010.Pricing American options under stochastic volatility and stochastic interest rates — 未標示
**來源**: E:/課程/財務工程_隨機財務理論/隨機微積分/177516_JFE.2010.Pricing American options under stochastic volatility and stochastic interest rates.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
- **Pricing American options under stochastic volatility and stochastic interest rates**
  ...
  - Fourth-order expansion of the solution to the modified problem under the Black-Scholes model
  - Proof of Proposition 2
  - Third-order expansion of the solution to the modified problem under an affine three-factor model
