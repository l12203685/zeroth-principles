## 台灣指數選擇權VIX最適預測模型 — CARR模型之應用
**來源**: E:/投資交易/交易學習資料庫/@交易/@option and volatility trading/理論類/台灣指數選擇權VIX最適預測模型---CARR模型之應用.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
### TL;DR (≤120字)
本書屬於 options volatility 範疇,作者 CARR模型之應用 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
