## smm2013h3 — 未標示
**來源**: E:/課程/財務金融_證券市場微結構理論/homeworks/smm2013h3.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Consider a futures market which opens at date 0. The futures**
- **2. Consider the following two-period REE model. There are two al**
