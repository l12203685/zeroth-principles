## 971106 The Root and Ratio Test — 未標示
**來源**: E:/課程/數學統計_高等微積分/課程講義/971106 The Root and Ratio Test.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. The ratio test is frequently easier to apply than the root te**
- **2. Whenever the ratio test shows convergence, the root test does**
