## Appendix 5. Riemann — Stieltjes Integrals
**來源**: E:/課程/財務工程_財務工程導論/課程講義/Appendix 5. Riemann-Stieltjes Integrals.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **2.
Hence,**
- **2.
E.3.4. Comparison theorem.**

### TL;DR (≤120字)
本書屬於 statistics evidence based 範疇,作者 Stieltjes Integrals 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
