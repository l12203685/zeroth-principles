## Baxter - Financial Calculus — An Introduction to derivative pricing
**來源**: E:/書籍/Baxter - Financial Calculus - An Introduction to derivative pricing.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 2: hapter 3 ontents Preface**
  - Chapter 4: Pricing market securities
  - Chapter 5: Interest rates
  - Chapter 6: Bigger models
  - Chapter 1: Introduction F
  - Chapter 2: Discrete processes T he goal of this book is to explore the limits of arbitrage. Bit by

### TL;DR (≤120字)
本書屬於 risk management 範疇,作者 An Introduction to derivative pricing 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
