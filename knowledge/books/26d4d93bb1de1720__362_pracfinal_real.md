## 362-pracfinal-real — 未標示
**來源**: E:/課程/[3] 數理統計/數統二練習題/362-pracfinal-real.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1.
(25 points)**
- **2. (25 points)**
- **3. (15 points) A Weibell distribution is a distribution with f(x**
- **4. (30 points) Let X1, . . . , Xn have the Poisson(θ) distributi**
- **5. (25 points) Let X1, . . . , Xn be a random sample from a Γ(α,**
- **6. (25 points) Suppose X1, . . . , Xn are a sample from the foll**
- **7. (25 points) Let X1, . . . , Xn denote a random sample from a**
- **8. (25 points) The Pareto distribution has CDF**
