## The Hidden Correlation of Collateralised Debt Obligatsions — 未標示
**來源**: E:/課程/0. 碩士論文/參考資料/Base correlation/The Hidden Correlation of Collateralised Debt Obligatsions.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
- **Modeling the Correlation Matrix**
  - Empirical Correlations and RMT
  - Group Models
  - Attainable Correlation Smiles
- **Numerical Implementation**
  - Integration Schemes
  - Existence and Uniqueness of Correlation
  - Performance
- **Conclusions**
