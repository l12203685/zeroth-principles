## extraprobs — 未標示
**來源**: E:/課程/數學統計_數理統計/數統二練習題/extraprobs.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Suppose X1, . . . , Xn have the pdf f(x) = 1**
- **2. Book problem 6.3.9.**
- **3. X1, . . . , Xn are from some pdf f(x; θ) that satisfy all reg**
