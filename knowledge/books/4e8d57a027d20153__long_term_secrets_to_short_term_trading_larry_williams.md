## 短線交易密訣 Long-Term Secrets to Short — Term Trading, Larry Williams
**來源**: E:/書籍/短線交易密訣 Long-Term Secrets to Short-Term Trading, Larry Williams.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **短線交易密訣 Long-Term Secrets to Short**
  - 主題範疇: general trading
  - 目錄未能自動提取,以主題領域概括

### TL;DR (≤120字)
本書屬於 general trading 範疇,作者 Term Trading, Larry Williams 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
