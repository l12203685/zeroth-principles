## Homework-17 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_賽局理論/homework/Homework-17.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Two players have to simultaneously and independently decide h**
- **1. Player 2 pays the cost**
- **2. The number t is private**
- **2. Suppose that nature selects A with probability 1/2 and B with**
- **3. Consider a diﬀerentiated duopoly market in which ﬁrms compete**
- **4. Consider a simple simultaneously-bid poker game. First, natur**
- **5. Consider an “all-pay” auction with two players (the bidders).**
