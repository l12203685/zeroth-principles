## Basel Capital Charge Material — 未標示
**來源**: E:/投資交易/量化金融文獻/Basel Capital Charge Material.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Minimum capital requirements for Market Risk**
  - Executive Summary
  - Overview of the revised internal models approach for market risk
  - Overview of the revised standardised approach for market risk
  ...
  - Appendix A - Trading desk definitions
