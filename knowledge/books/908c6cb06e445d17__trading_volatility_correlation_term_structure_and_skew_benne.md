## Trading Volatility, Correlation, Term Structure and Skew, Bennent — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/@選擇權/Trading Volatility, Correlation, Term Structure and Skew, Bennent.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
- **CHAPTER 5**
  - LIGHT EXOTICS
- **CHAPTER 6**
  - RELATIVE VALUE AND CORRELATION TRADING
- **CHAPTER 7**
  ...
  - A.5: PROOF VARIANCE SWAP NOTIONAL = VEGA/2
