## Econometrics_Analysis_Ch1,2,3. — 未標示
**來源**: E:/課程/筆記/Econometrics_Analysis_Ch1,2,3..pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 1,2,3.**
- **1. Compare average test scores in districts with low STRs to tho**
- **2. Test the "null" hypothesis that the mean test scores in the t**
- **3. Estimate an interval for the di erence in the mean test score**
- **1. Estimation of ∆=diﬀerence between group means.**
- **2. Test the hypothesis that ∆=0.**
- **3. Construct a conﬁdence interval for ∆.**
