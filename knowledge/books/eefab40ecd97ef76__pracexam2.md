## pracexam2 — 未標示
**來源**: E:/課程/數學統計_數理統計/數統一練習題/pracexam2.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1.
(20 points) A coin is ﬂipped until there are two heads in a r**
- **2. (20 points) Three integers are chosen with replacement from t**
- **3. (20 points) X is a continuous random variable with cdf FX(x)**
- **4. (20 points) A random integer N from 1 to 10 is chosen uniform**
- **5. (20 points) Is it possible for two events A and B with P(A),**
