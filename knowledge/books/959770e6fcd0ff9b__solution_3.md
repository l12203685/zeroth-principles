## Solution-3 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_賽局理論/homework solution/Solution-3.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Suppose we have a game where S1 = {H, L} and S2 = {X, Y }. If**
- **2. Consider a version of the Cournot duopoly game, where ﬁrms 1**
