## TechnicalNote1 — 未標示
**來源**: E:/課程/財務金融_衍生性金融商品市場與定價/衍金証明/TechnicalNote1.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. The diﬀerence between a futures contract that is settled dail**
- **2. The diﬀerence between the contract that is settled at time T1**
