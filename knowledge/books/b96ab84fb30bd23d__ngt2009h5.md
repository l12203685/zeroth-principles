## ngt2009h5 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW/ngt2009h5.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Recall the game of beer and quiche. We shall now make some mo**
- **2. Let us modify the game of chain-store paradox in Lecture 4 by**
- **3. At date 0, there is a borrowing ﬁrm that has three possible t**
- **4. Consider a two-period model where at date 1, ﬁrm W is all equ**
