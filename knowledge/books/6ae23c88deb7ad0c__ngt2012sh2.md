## ngt2012sh2 — 未標示
**來源**: E:/課程/經濟_商業賽局模型/HW/解答/ngt2012sh2.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (Loyalty Program) Firm I (the incumbent) is trying to sell a**
- **2. There is a poten-**
- **2.
(c) Show that consumer A’s expected consumer surplus is 1**
- **4.
(We assume that all players in this game are risk-neutral; ﬁr**
- **16.
(e) Explain why ﬁrm I did not choose P0 = P to completely blo**
