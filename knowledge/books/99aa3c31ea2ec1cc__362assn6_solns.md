## 362assn6-solns — 未標示
**來源**: E:/課程/數學統計_數理統計/數統二練習題/362assn6-solns.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (6.1.2) Let X1, X2, . . . , Xn be a random sample from a Γ(α**
- **2. (6.1.5) Suppose X1, . . . , Xn are iid with pdf f(x; θ) = 2x/**
- **2.
Thus ˆQ2 = Yn**
- **2.
3. (6.1.9) Suppose X1, . . . , Xn are iid with pdf f(x; θ) =**
- **4. (6.1.10) If X1, X2, . . . Xn be a random sample from a Bernou**
- **2. Thus ˆθ = max{ 1**
- **5. (6.2.1) Prove that ¯X, the mean of a random sample of size n**
- **6. (6.2.7’) Let X have a gamma distribution with α = 3 and β = θ**
