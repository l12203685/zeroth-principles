## 2021-MTP — Workbook
**來源**: E:/投資交易/交易學習資料庫/@交易/@股票/超級績效MM2021/2021-MTP-Workbook.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Take Minimal Risk**
- **2. Capture Relatively Large Gains**
- **3. Maximize Compounding**
- **1.
Categories and Catalysts**
- **2.
Price & Volume**
- **3.
...
### TL;DR (≤120字)
本書屬於 risk management 範疇,作者 Workbook 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
