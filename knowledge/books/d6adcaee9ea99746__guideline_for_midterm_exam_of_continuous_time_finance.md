## Guideline for Midterm Exam of Continuous — Time Finance
**來源**: E:/課程/財務工程_隨機財務理論/Guideline for Midterm Exam of Continuous-Time Finance.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (Chap 1.5) Fundamental Theorems of Asset Pricing**
- **2. Characterizations of Complete/Incomplete Markets. For example**
- **3. (Chap 1.6) Feynman-Kac formula. Conditional expectation and P**
- **4. (Chap 3.4, 3.5, 4.1(except 4.1.3, 4.1.4))  Simulation method,**

### TL;DR (≤120字)
本書屬於 options volatility 範疇,作者 Time Finance 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
