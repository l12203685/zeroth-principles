## matrix-analysis-w13 — 未標示
**來源**: E:/課程/[1] 線性代數/線性代數/matrix-analysis-w13.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **2. r(x)x൑Ax ∀x൒0 & r(x) is the largest p ∋ px൑Ax ∀x൒0**
- **3. A=[ܽ௜௝], x=൥**
- **4. r(x)=r(px) ∀p൐0**
