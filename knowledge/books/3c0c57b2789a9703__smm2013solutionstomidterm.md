## smm2013solutionstomidterm — 未標示
**來源**: E:/課程/財務金融_證券市場微結構理論/smm2013solutionstomidterm.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (Managerial Contract Design with Insider Trading) At date 0,**
- **50.
Everyone appearing in this economy, including the professiona**
- **2.
The ﬁrm’s common stock is traded in the stock market at date**
- **2.
At date 1**
- **2. The stock market closes**
- **64. Find the equilibrium oﬀer (A, B) for Mr. A.**
- **2. Suppose**
