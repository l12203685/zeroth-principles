## assn7-solns — 未標示
**來源**: E:/課程/數學統計_數理統計/數統一練習題/assn7-solns.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (1.9.6) Let the random variable X have E[X] = µ, E[(X −µ)2] =**
- **2. (1.9.7) Show that the moment generating function of the rando**
- **3. (1.9.18) Find the moments of the distribution that has mfg M(**
- **4. (1.9.23) Consider k continuous-type distributions with the fo**
- **5. (1.10.4) Let X be a random variable with mgf M(t), −h < t < h**
- **6. (1.10.3) If X is a random variable such that E[X] = 3 and E[X**
