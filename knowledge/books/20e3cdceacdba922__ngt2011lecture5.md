## ngt2011lecture5 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/Lecutre/ngt2011lecture5.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. We shall give a series of applications to ﬁnance and marketin**
- **2. Example 1.**
- **3. Note that in the Bertrand equilibrium of the subgame where ma**
