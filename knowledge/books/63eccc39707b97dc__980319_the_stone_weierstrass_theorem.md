## 980319 The Stone — Weierstrass Theorem
**來源**: E:/課程/[2] 高等微積分/980319 The Stone-Weierstrass Theorem.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **3.  If {**

### TL;DR (≤120字)
本書屬於 general trading 範疇,作者 Weierstrass Theorem 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
