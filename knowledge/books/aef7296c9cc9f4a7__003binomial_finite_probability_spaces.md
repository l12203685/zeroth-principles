## 003Binomial — Finite probability spaces
**來源**: E:/投資交易/交易學習資料庫/@交易/2. 財務相關知識/財務數學/003Binomial-Finite probability spaces.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **2. s-algebra**
- **3.    投資者可知的訊息**
- **1. W, a nonempty set, called the sample space, which contains**
- **2.      a s-algebra of subsets of W.**
- **3. P, a probability measure on (W,      ), i.e., a function whic**
- **1. 
 
2.**
- **2. If                   is a sequence of disjoint sets in**

### TL;DR (≤120字)
本書屬於 statistics evidence based 範疇,作者 Finite probability spaces 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
