## nsp7 — 未標示
**來源**: E:/課程/[6] 證券市場微結構/prerequirements/nsp7.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Given a measurable space (Ω, F), an extended real-valued set**
- **2. A measurable set A ∈F is ν-positive (negative) if for all E ∈**
- **3. Two measures µ and ν are mutually singular on (Ω, F) if there**
- **4. Proposition 2 Each signed measure ν on the measurable space (**
