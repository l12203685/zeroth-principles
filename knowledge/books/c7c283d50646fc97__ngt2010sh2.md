## ngt2010sh2 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW (1)/解答/ngt2010sh2.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (Loyalty Program) Firm I (the incumbent) is trying to sell a**
- **2. There is a**
- **2. Show that without loyalty**
- **4.
Show that under the optimal loyalty program, the probability**
- **16. Why did ﬁrm I not choose P0 = P**
- **4.
Now we compute consumer A’s expected payoﬀ. Note that wheneve**
- **4.
1To see this, suppose that pI > pE > ce, but then ﬁrm I would**
