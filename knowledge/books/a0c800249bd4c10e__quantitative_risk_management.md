## Quantitative Risk Management — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/2. 財務相關知識/風險管理/Quantitative Risk Management.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Risks, Losses and Risk Factors**
- **2. Example: Portfolio of Stocks**
- **3. Conditional and Unconditional Loss Distributions**
- **4. Linearization of Loss**
- **5. Example: European Call Option**
