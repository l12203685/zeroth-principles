## Volatile Markets Made Easy_ Trading Stocks and Options for Increased Profits ( PDFDrive ) — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/@選擇權/Volatile Markets Made Easy_ Trading Stocks and Options for Increased Profits ( PDFDrive ).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
- **Chapter 2 Trends and Flags**
  ...
  - Learning Points
- **Chapter 3 Options and the Greeks**
  - Delta
  - Gamma
  - Theta
  - Vega
...
- **Chapter 4 Straddles and Strangles**
  - Straddles
  - Strangles
  - Factors Affecting Straddles and Strangles
- **Chapter 5 Ratio Backspreads**
  - Call Ratio Backspreads
  - Put Ratio Backspreads
  - Learning Points
- **Chapter 6 Diagonal Spreads**
  - The Basic Covered Call
  - Diagonal Calls
  - Diagonal Puts
  - Summary
- **Chapter 7 The Practical Way to Trade Volatility**
  - Steps
  - Learning Points
- **Chapter 8 The Science of Volatility**
  - Historical and Implied Volatility
  - Option Pricing Models
  - Learning Points
- **Chapter 9 Trading Plans and Putting It All Together**
  - Flag Trades
