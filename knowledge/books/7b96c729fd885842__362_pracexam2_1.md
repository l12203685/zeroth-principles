## 362-pracexam2-1 — 未標示
**來源**: E:/課程/數學統計_數理統計/數統二練習題/362-pracexam2-1.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (25 points) We are able to generate a random variable U which**
- **2. (25 points) X1, . . . , Xn are a sample from a Γ(2, θ) distri**
- **3. (20 points) X1, . . . , Xn are drawn from the geometric distr**
- **4.
(30 points)**
