## Exam_FM_2005_sol — 未標示
**來源**: E:/投資交易/研究與模型/SOA/SOA Past Exam_Preliminery/Exam_FM_2005_sol.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Present value = 897, future value = 1050, payment = 80, and number of periods = 20.**
- **i = 9.24%.**
- **The total price is 8984.73 + 9609.38 = 18,594.11**
