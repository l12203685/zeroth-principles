## 演習 5 — 未標示
**來源**: E:/課程/經濟_個體經濟學/演習 5.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Suppose Joe's utility for lobster (L) and soda (S) can be rep**
- **2. John is indifferent between canned soup and fresh soup. Canne**
- **3. Suppose that left shoes and right shoes must be purchased sep**
- **4. Lisa consumes only pizzas (P) and burritos (B). Her utility f**
- **5. The preferences for Californians can be represented by the fo**
