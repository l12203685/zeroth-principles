## 980326 Some Special Functions — 未標示
**來源**: E:/課程/數學統計_高等微積分/課程講義/980326 Some Special Functions.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. f  is continuous in (**
- **2. f  is differentiable in (**
- **3. Let [ , ]**
- **1. f  has derivatives of all orders in (**
- **2. 
( )(0)**
- **3. Suppose both**
- **1. Does**
- **2. Suppose the series**
