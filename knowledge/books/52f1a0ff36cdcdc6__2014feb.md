## 2014FEB — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/雜誌/2014FEB.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Part 2: butterfly) on Thursday (eight days to expiration) and Monday (four days to expiration). The risk curve of an AAPL iron butterfly is displayed in Figure 1. Currently, he favors the**
