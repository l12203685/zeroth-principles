## ngt2012h1 — 未標示
**來源**: E:/課程/經濟_商業賽局模型/HW/ngt2012h1.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (Duopolistic ﬁrms submitting supply curves) Recall the Courno**
- **2. (Competitive Manufacturers May Make More Proﬁts with**
- **3.
For part (ii), notice that when b = 0, this equilibrium coinc**
- **81. (Hint: Backward induction**
- **3. Reconsider the Bertrand game discussed in class. Assume that**
