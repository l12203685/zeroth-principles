## Peter N. Posch -Credit Risk Modeling using Excel and VBA  Gunter Lцffler — Wiley  (2007)
**來源**: E:/書籍/Peter N. Posch -Credit Risk Modeling using Excel and VBA  Gunter Lцffler-Wiley  (2007).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Credit—Management**
- **2. Risk Management**
- **3. Microsoft Excel (Computer file)**
- **4. Microsoft Visual Basic for applications.**

### TL;DR (≤120字)
本書屬於 statistics evidence based 範疇,作者 Wiley  (2007) 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
