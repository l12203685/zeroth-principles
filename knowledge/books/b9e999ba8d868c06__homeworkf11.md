## HomeworkF11 — 未標示
**來源**: E:/課程/數學統計_數理思維/HomeworkF11.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1.
找一個人們違反完全理性假設的實例，可以引用別人實驗結果或自**
- **2.
找一個真實世界中類似囚徒困境、重複囚徒困境、或旅行者困境的**
- **3.
台灣的選舉非常多，找一個明顯受惠于選制的實例(例如課堂談到**
- **4.
考慮一個自然界或人類社會的現象，這個現象能與堆沙遊戲類比，**
