## ngt2012h3 (1) — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW (1)/ngt2012h3 (1).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. (Entry Deterrence by a Monopolistic Incumbent.)**
- **5. Find the equilibrium qA1 and qA2.**
- **25. Find the equilibrium qA1 and qA2.**
- **2. (Advance Selling and Resale.)**
- **2.
Everyone appearing in this problem is risk neutral without ti**
- **2. Mr. A**
- **3. (Double Couponing.) A manufacturer M produces a product cost-**
- **4.
The game proceeds as follows. R ﬁrst announces that, if M cho**
