## Note_3.4.1 for Normal Distribution — 未標示
**來源**: E:/課程/[3] 數理統計/Note_3.4.1 for Normal Distribution.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Expectation: E[X] = µ**
- **2. Variance: V ar[X] = σ2**
- **3. Skewness:**
- **4. Kurtosis:**
- **5. Zi ∼N(µi, σ2**
- **6. Φ(z0) + Φ(−z0) = 1**
- **7. Some important crtical value:**
- **8. E[Xk] = E[(σZ +µ)k] = E[Pk**
- **1. bell-shape curve**
- **2. symmetry about x = µ**
