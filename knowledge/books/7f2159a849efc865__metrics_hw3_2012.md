## metrics_hw3_2012 — 未標示
**來源**: E:/課程/經濟_數量方法入門/metrics_hw3_2012.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. This problem is about dummy variables in**
- **2. Consider the following location-scale quan-**
- **3. (Computer Simulations) Consider the fol-**
