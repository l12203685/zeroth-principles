## 07_mhgame — 未標示
**來源**: E:/課程/[3] 賽局理論/examples/07_mhgame.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 7: Each student works as a salesman for Apex, Brydox, or neither firm, choosing anew each year. Each year you also pick your eﬀort level, which is unobserved by the firms. Your sales equal**
