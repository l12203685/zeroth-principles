## template_figure_ps_pdf — 未標示
**來源**: E:/課程/0. 未整理/template_figure_ps_pdf.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. 為所有JPG 檔製作圖形尺寸檔(即bb 檔), 作法很簡單, 如圖2所示。這個**
- **2. 新版cwtex 3.3 在使用graphicx 的套件時, 需加註dvipdfm 為**
