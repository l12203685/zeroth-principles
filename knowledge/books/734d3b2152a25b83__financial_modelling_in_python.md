## Financial Modelling in Python — 未標示
**來源**: E:/投資交易/量化金融文獻/Financial Modelling in Python.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Finance—Mathematical models—Computer programs.**
- **2. Python (Computer program language)**
