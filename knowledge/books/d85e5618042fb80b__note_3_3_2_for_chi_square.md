## Note_3.3.2 for Chi — Square
**來源**: E:/課程/[3] 數理統計/NOTE/Note_3.3.2 for Chi-Square.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Expectation: E[X] = r**
- **2. Variance: V ar[X] = 2r**
- **3. Skewness:**
- **4. Kurtosis:**
- **5. E[Xk] = Γ( r**

### TL;DR (≤120字)
本書屬於 general trading 範疇,作者 Square 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
