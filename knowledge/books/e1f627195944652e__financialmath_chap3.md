## financialmath-chap3 — 未標示
**來源**: E:/投資交易/交易學習資料庫/@交易/2. 財務相關知識/財務數學/交大課程講義/financialmath-chap3.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 3: One-Period Models Assumptions: (1)  t = 0, 1.**
