## edu-2012-04-mlc-exam — 未標示
**來源**: E:/課程/證照考試資料/SOA/3. MLC/edu-2012-04-mlc-exam.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. 
For a 2-year select and ultimate mortality model, you are giv**
- **2. 
You are given:**
- **3. 
For a fully discrete 3-year term insurance of 10,000 on (40),**
- **4. 
For a 3-year term insurance of 1000 on [75], you are given:**
- **5. 
For a whole life insurance on (80):**
- **6. 
Two whales, Hannibal and Jack, occupy the Ocean World aquariu**
- **7. 
For a single premium product replacement insurance on a compu**
- **8. 
For a fully discrete whole life insurance of 1000 on (80):**
- **9. 
A special fully discrete 3-year endowment insurance on (x) pa**
- **10. For a universal life insurance policy on Julie, you are given**
