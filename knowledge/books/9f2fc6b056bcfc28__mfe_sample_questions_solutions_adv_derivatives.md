## mfe-sample-questions-solutions-adv-derivatives — 未標示
**來源**: E:/投資交易/研究與模型/SOA/4. MFE/mfe-sample-questions-solutions-adv-derivatives.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)
...
- **ADVANCED DERIVATIVES**
  ...
  - (See also formula 9.8 on page 271.) Note that and are time-0 prices of exchange options. The two exchange options have the same price if and only if the two prepaid forward prices, and , are the same.
- **Put Price**
- **Call Price**
- **Strike Price**
- **$3**
