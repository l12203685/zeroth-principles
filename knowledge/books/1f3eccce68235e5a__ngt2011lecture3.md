## ngt2011lecture3 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/Lecutre (1)/ngt2011lecture3.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. This note consists of two parts. In the ﬁrst part, we review**
- **2. Deﬁnition 1.**
- **3. Let us make the above deﬁnition more formal, and derive sever**
- **4. Given (Ω, Hi, Pi), for each state ω ∈Ω, there exists hi(ω) ∈H**
- **5. An event is any element of σ(Hi). We say that an event E occu**
- **6. Now let us denote the event (or the set of states where) play**
- **7. Given {Hi; i ∈I}, the meet M of these information partitions**
