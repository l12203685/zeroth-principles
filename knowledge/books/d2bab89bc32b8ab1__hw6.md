## HW6 — 未標示
**來源**: E:/課程/財務工程_隨機財務理論/HW/HW6.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. 利用布朗運動的模擬來驗證**
- **2. 令 !!!! 為一平賭且對任何 !，! 是平方可積，! !!**
- **3. （Shreve’s book）Exercise 3.4**
- **4. （Shreve’s book）Exercise 3.6**
- **5. （Shreve’s book）Exercise 4.1**
- **6. （Shreve’s book）Exercise 4.5**
- **7. （Shreve’s book）Exercise 4.6**
- **8. （Shreve’s book）Exercise 4.7**
