## 970925 Cardinality of Sets — 未標示
**來源**: E:/課程/數學統計_高等微積分/課程講義/970925 Cardinality of Sets.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. In other words, a countable set can not have any uncountable**
- **2. Similar argument as the proof can show that if A  is infinite**
- **3. Roughly speaking, countable sets are the “smallest” infinite**
- **4. Consequently, every subset of a countable set is at most coun**
