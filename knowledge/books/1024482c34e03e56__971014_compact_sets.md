## 971014 Compact Sets — 未標示
**來源**: E:/課程/[2] 高等微積分/971014 Compact Sets.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Let**
- **2. Let**
- **1. By (a) and (c), E  is the smallest closed subset of X that co**
- **2. By (a) and (c), we have that if A**
- **1. Is it true that A**
- **2. Is it true that A**
- **1. Every finite set is compact.**
- **2. (0,1)  is not compact (in R).**
- **3. R is not compact (in R).**
