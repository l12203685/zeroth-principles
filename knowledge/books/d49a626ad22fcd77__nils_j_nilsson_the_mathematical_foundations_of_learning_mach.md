## Nils J Nilsson-The mathematical foundations of learning machines — Morgan Kaufmann (2005)
**來源**: E:/書籍/Nils J Nilsson-The mathematical foundations of learning machines-Morgan Kaufmann (2005).pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Chapter 1: Preliminaries 1.1 Introduction**
  - Chapter 2: Boolean Functions 2.1 Representation

### TL;DR (≤120字)
本書屬於 ml for finance 範疇,作者 Morgan Kaufmann (2005) 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
