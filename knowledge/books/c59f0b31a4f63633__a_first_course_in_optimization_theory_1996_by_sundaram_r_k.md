## A First Course In Optimization Theory, 1996 — Sundaram R. K.
**來源**: E:/書籍/A First Course In Optimization Theory, 1996, by Sundaram R. K..pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **A First Course In Optimization Theory, 1996**
  - 主題範疇: general trading
  - 目錄未能自動提取,以主題領域概括

### TL;DR (≤120字)
本書屬於 general trading 範疇,作者 Sundaram R. K. 聚焦在零式投資體系中與交易成本、風險控制、樣本外穩健性相關的核心議題。
