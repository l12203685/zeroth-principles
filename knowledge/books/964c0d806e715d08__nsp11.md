## nsp11 — 未標示
**來源**: E:/課程/[5] 隨機過程/nsp11.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Throughout this note, a ﬁxed ﬁltered probability space (Ω, F,**
- **2. Deﬁnition 1 Let x : Ω× T →ℜbe an adapted stochastic process**
- **3. We shall ﬁrst treat the case where T is countable and review**
- **4. Example 1 Suppose that {xn; n ∈Z+} is a sequence of independe**
- **5. Theorem 1 If {(xn, Fn; n ∈N} is a submartingale and f : ℜ→ℜ**
