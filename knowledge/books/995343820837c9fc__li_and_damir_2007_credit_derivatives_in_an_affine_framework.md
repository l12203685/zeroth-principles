## Li and Damir, 2007, Credit Derivatives in an Affine Framework — 未標示
**來源**: E:/課程/0. 碩士論文/參考資料/Li and Damir, 2007, Credit Derivatives in an Affine Framework.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Credit Derivatives in an Affine Framework**
- **Abstract**
- **Introduction**
- **The Basic Three-Firm Model**
- **Basic Trick**
- **Joint Distribution of Default Times**
- **Example of a Continuous Joint Density**
- **Default Correlation**
- **Valuing Credit Default Swaps**
- **Swaption Pricing by Affine Approximation**
- **Conclusion**
