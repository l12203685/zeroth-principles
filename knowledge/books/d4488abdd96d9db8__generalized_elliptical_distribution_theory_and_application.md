## Generalized Elliptical Distribution Theory and Application — 未標示
**來源**: E:/書籍/Generalized Elliptical Distribution Theory and Application.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **Part I: Theory**
  - Chapter 1: Elliptically Symmetric Distributions The class of elliptically symmetric distributions has been well investigated by Cambanis,
