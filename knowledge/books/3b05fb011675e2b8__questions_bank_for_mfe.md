## Questions Bank for MFE — 未標示
**來源**: E:/投資交易/研究與模型/SOA/4. MFE/Questions Bank for MFE.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. You are given that S0= $47, and a $45-strike call option 6 mo**
- **2. You are given the following information:**
- **3. Which of the followings is false about put-call parity?**
- **4. Which of the followings is incorrect?**
- **5. You are given that:**
- **1. This is a simple Put-Call Parity question.**
- **2. This is testing on the Put-Call Parity but leaving the answer**
- **3. (C) is incorrect as put-c**
