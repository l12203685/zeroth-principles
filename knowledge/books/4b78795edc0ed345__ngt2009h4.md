## ngt2009h4 — 未標示
**來源**: E:/課程/[3] 賽局理論/經濟_商業賽局模型/HW (1)/ngt2009h4.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. Consider the following game G(∞) in which a seller and a buye**
- **2. Consider the following repeated game G(∞) with a seller and a**
- **3. Consider the following simultaneous game G(1): two players si**
- **4. A seller is trying to sell his product (product Z) to two buy**
- **2.
Find the SPNE for this game. What are the equilibrium values**
