## R-hw2 — 未標示
**來源**: E:/課程/[5] 計量理論/計量理論/R/R-hw2.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1. 
Verify the results of the example (suicide and unemployment)**
- **2. 
(# iv at page 20 in the lecture note: Getting Started With R)**
