## Exam_M_2000 — 未標示
**來源**: E:/課程/證照考試資料/SOA/SOA Past Exam_Preliminery/Exam_M_2000.pdf  |  **消化日**: 2026-04-18  |  **模型**: machine_template_v1 (batch C)

### 目錄
- **1.
Given:**
- **2.
Lucky Tom finds coins on his way to work at a Poisson rate of**
- **3.
For a fully discrete two-year term insurance of 400 on (x):**
- **4.
You are given:**
- **5.
An insurance company has agreed to make payments to a worker**
- **6.
A special purpose insurance company is set up to insure one s**
- **7.
In a triple decrement table, lives are subject to decrements**
- **8.
For a two-year term insurance on a randomly chosen member of**
- **9.
For a 10-year deferred whole life annuity of 1 on (35) payabl**
- **10.
Taxicabs leave a hotel with a group of passengers at a Poisso**
